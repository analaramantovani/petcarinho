...
agendamentos = [{
    ...
    },
    {
        ...
        'codigovet': 5,
        'nomevet': 'Mariana',
        'datahora': '2025-07-02T14:30',
        'sintomas': 'Coceira e queda de pelo',
        'remarcavel': True,
        'datahora_obj': datetime(2025, 7, 2, 14, 30),
        'datahora_formatada': '02/07/2025 às 14:30',
        'data_somente': date(2025, 7, 2),
    },
    {
        'ativo': True,
        'codigo': 3,
        ...
        'codigovet': 6,
        'nomevet': 'João',
        'datahora': '2025-07-03T11:00',
        'sintomas': 'Dificuldade para andar',
        'remarcavel': True,
        'datahora_obj': datetime(2025, 7, 3, 11, 0),
        'datahora_formatada': '03/07/2025 às 11:00',
        'data_somente': date(2025, 7, 3),
    },
    {
        'ativo': True,
        'codigo': 4,
